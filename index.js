...
console.log('task 1a: ',createMenuItem('Dorho', 11, 'dinner'));
...
*/
reviews.unshift({name:'sirak', rating:5, feedback:'asmara eritrean is beautiful'});
...
function getLastReview(array) {
  /*Your code here*/
  const lastString=array.length-1;
  
  return `${array[lastString].name} gave the restaurant a ${array[lastString].rating} star review, and their feedback was: ${array[lastString].feedback}`;
} 
